    ...
    <form action="{{ route('alquiler.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <select name="socId" id="socId" class="form-control" required>
                ...
                <option value="{{ $socio->socId }}">{{ $socio->socNombre }}</option>
                @endforeach
            </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="date" name="alqFechaDesde" id="alqFechaDesde" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="alqFechaHasta">Fecha Hasta</label>
            <input type="date" name="alqFechaHasta" id="alqFechaHasta" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="alqValor">Valor</label>
            <input type="number" name="alqValor" id="alqValor" class="form-control" step="0.01" required>
        </div>
        <div class="form-group">
            <label for="alqFechaEntrega">Fecha de Entrega</label>
            <input type="date" name="alqFechaEntrega" id="alqFechaEntrega" class="form-control">
        </div>
